...
// Cross Module References
	DECADE_API UClass* Z_Construct_UClass_UCubemonHP_NoRegister();
	DECADE_API UClass* Z_Construct_UClass_UCubemonHP();
...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCubemonHP_Statics::NewProp_Cubemon = { "Cubemon", nullptr, (EPropertyFlags)0x0010000000000004, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCubemonHP, Cubemon), Z_Construct_UClass_ACubemon_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCubemonHP_Statics::NewProp_Cubemon_MetaData, ARRAY_COUNT(Z_Construct_UClass_UCubemonHP_Statics::NewProp_Cubemon_MetaData)) };
	...
	IMPLEMENT_CLASS(UCubemonHP, 1155104703);
	template<> DECADE_API UClass* StaticClass<UCubemonHP>()
	{
		return UCubemonHP::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UCubemonHP(Z_Construct_UClass_UCubemonHP, &UCubemonHP::StaticClass, TEXT("/Script/Decade"), TEXT("UCubemonHP"), false, nullptr, nullptr, nullptr);
